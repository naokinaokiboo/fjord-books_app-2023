...
ActiveRecord::Schema[7.0].define(version: 2023_08_28_083140) do
  ...
  create_table "report_mentions", force: :cascade do |t|
    ...
    t.index ["mentioning_report_id", "mentioned_report_id"], name: "index_on_mentioning_report_id_and_mentioned_report_id", unique: true
